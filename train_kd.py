...
class Trainer(object):
    ...
    def training(self, epoch):
        ...
        for i, sample in enumerate(tbar):
            ...
            output, pa_loss, pi_loss, ic_loss, lo_loss, SA_loss, loss_distill = self.d_net(image)
            ...
            loss = loss_seg + pa_loss + pi_loss + lo_loss + SA_loss + ic_loss + loss_distill / image.shape[0] * 1e-5
